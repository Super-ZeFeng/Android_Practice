package com.zefeng.weatherreport.db;
 ...
 */
public class WeatherReportHelper extends SQLiteOpenHelper {
    /**
     * Province表建表语句
     */
    ...
    public WeatherReportHelper(Context context, String name, SQLiteDatabase.CursorFactory factory, int version) {
